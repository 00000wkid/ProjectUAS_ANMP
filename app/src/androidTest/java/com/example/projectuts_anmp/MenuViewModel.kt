...
class MenuViewModel : ViewModel() {
    ...
    // Fungsi ini digunakan untuk memperbarui data "appetizers" dan "rice and noodles" dari sumber data
    fun refreshMenuData() {
        // Implementasi logika untuk mengambil data "appetizers" dan "rice and noodles" dari sumber data

        // Contoh: Mengisikan data "appetizers" dengan beberapa item menu
